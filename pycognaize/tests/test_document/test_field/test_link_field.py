...
class TestLinkField(unittest.TestCase):
    ...
    def test___repr__(self):
        repr_str_2 = f"<{self.link_field_2.__class__.__name__}: {self.raw_link2['name']}: https://uat.cognaize.com/browse/62853fcaf22a6700138cb7d0>"
        self.assertEqual(repr(self.link_field_2), repr_str_2)

        repr_str_3 = f"<{self.link_field_3.__class__.__name__}: {self.raw_link3['name']}: http://www.iaasa.ie/getmedia/b23890131cf6458b9b8fa98202dc9c3a/>"
