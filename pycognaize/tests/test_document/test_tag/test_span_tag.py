...
class TestSpanTag(unittest.TestCase):
    ...
    def test_raw_value(self):
        self.assertEqual(self.ext_tag_1.raw_value,
                         self.ext_tag_dict_1['value'])
        self.assertEqual(self.ext_tag_2.raw_value,
                         self.ext_tag_dict_2['value'])
    ...
    def test_coordinates(self):
        self.assertAlmostEqual(str(self.ext_tag_1.top),
                               self.ext_tag_dict_1['top'][:-1])
