...
class TestLazyDict(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        with open(RESOURCE_FOLDER +
                  '/snapshots/60f554497883ab0013d9d906/document.json', encoding="utf8")as document_json:
    ...
    def test___iter__(self):
        doc_list = sorted(
            ['60f554497883ab0013d9d906', '60b76b3d6f3f980019105dac',
             ...
             '5eb8ee1c6623f200192a0651', '63dfb66b7861050010cd64b5'])
        for i, value in enumerate(self.docs):
            self.assertEqual(doc_list[i], value)

    def test___len__(self):
        self.assertEqual(self.docs.__len__(), 14)
