...
class LazyGroupDict(Mapping):
    ...
    def __init__(self, document_x: dict, document_y: dict):
        self._groups = None
        self.create_groups(document_x, document_y)

    def create_groups(self, document_x: dict, document_y: dict):
        """Add fields to group """
        groups = defaultdict(dict)
        group_names = set()

        input_output_fields = [document_x, document_y]
        
        for document_fields in input_output_fields:
